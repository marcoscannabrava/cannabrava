...
// include: /tmp/tmp8l1692wn.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'simple-game.data';
      var REMOTE_PACKAGE_BASE = 'simple-game.data';
...
Module['FS_createPath']("/assets", "space-invaders", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_simple-game.data');

      };
      Module['addRunDependency']('datafile_simple-game.data');
    ...
    loadPackage({"files": [{"filename": "/assets/si1.png", "start": 0, "end": 10497}, {"filename": "/assets/si1b.png", "start": 10497, "end": 22327}, {"filename": "/assets/si2.png", "start": 22327, "end": 33175}, {"filename": "/assets/si2b.png", "start": 33175, "end": 45127}, {"filename": "/assets/si3.png", "start": 45127, "end": 55966}, {"filename": "/assets/space-invaders/si1.png", "start": 55966, "end": 66463}, {"filename": "/assets/space-invaders/si1b.png", "start": 66463, "end": 78293}, {"filename": "/assets/space-invaders/si2.png", "start": 78293, "end": 89141}, {"filename": "/assets/space-invaders/si2b.png", "start": 89141, "end": 101093}, {"filename": "/assets/space-invaders/si3.png", "start": 101093, "end": 111932}], "remote_package_size": 111932});

  })();

// end include: /tmp/tmp8l1692wn.js
// include: /tmp/tmp4nabga9s.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp4nabga9s.js
// include: /tmp/tmpfp2m_g51.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpfp2m_g51.js
...
function findWasmBinary() {
    return locateFile('simple-game.wasm');
}
...
var ASM_CONSTS = {
  97176: () => { if (document.fullscreenElement) return 1; },  
 97222: () => { return Module.canvas.width; },  
 97254: () => { return parseInt(Module.canvas.style.width); },  
 ...
 97448: () => { return Module.canvas.width; },  
 97480: () => { return screen.width; },  
 97505: () => { document.exitFullscreen(); },  
 97532: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97665: () => { return window.innerWidth; },  
 97691: () => { return window.innerHeight; },  
 97718: () => { if (document.fullscreenElement) return 1; },  
 97764: () => { return Module.canvas.width; },  
 97796: () => { return parseInt(Module.canvas.style.width); },  
 97844: () => { if (document.fullscreenElement) return 1; },  
 97890: () => { return Module.canvas.width; },  
 ...
 98046: () => { return Module.canvas.width; },  
 98078: () => { return screen.width; },  
 98103: () => { document.exitFullscreen(); },  
 98130: () => { if (document.fullscreenElement) return 1; },  
 98176: () => { return Module.canvas.width; },  
 98208: () => { return parseInt(Module.canvas.style.width); },  
 98256: () => { document.exitFullscreen(); },  
 98283: ($0) => { Module.canvas.style.opacity = $0; },  
 98321: () => { return screen.width; },  
 98346: () => { return screen.height; },  
 98372: () => { return window.screenX; },  
 98399: () => { return window.screenY; },  
 98426: () => { return window.devicePixelRatio; },  
 98462: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98515: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 98566: () => { Module.canvas.style.cursor = 'none'; },  
 98603: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 98859: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 98910: () => { if (document.fullscreenElement) return 1; },  
 98956: () => { return window.innerWidth; },  
 98982: () => { return window.innerHeight; },  
 99009: () => { if (document.pointerLockElement) return 1; }
};
